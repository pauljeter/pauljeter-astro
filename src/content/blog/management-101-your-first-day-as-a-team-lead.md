...
If you're coming in from outside the company, your brain's spinning from back-to-back onboarding meetings, figuring out the Wi-Fi (seriously, who has the password?), and realizing you've left your badge behind for the third time before lunch. If you've been promoted from within, you might be riding a wave of pride or wondering how things are going to shift now that you're managing people who were recently your peers. Can you still hang out with Jim and Ana on the weekend?

Depending on how much heads-up you had before starting, you might have a game plan for your first week. It's also normal if you're unsure what your output looks like now. You're not shipping code or closing JIRA tickets anymore. You're doing *manager stuff*. But what exactly is that?

Every company handles management differently. Maybe you've worked under a calm, methodical manager who preferred writing things down over chatting face-to-face. Or one who was great at inspiring but all over the place in execution. Or one who wasn't around much.

So what should you be doing? Here's a structure that helps you settle in, find clarity, and build momentum from the start.

---

## 1. Introduce Yourself Properly

Make it personal. Face-to-face if you're in the same space, or a video call if your team is remote. Don't default to Slack or email. Even if you've met some of the team during the hiring process, this is the time to start building trust.
...
Start with one-on-ones or group sessions, whichever feels natural for the people and the setting. Either way, take notes. These early insights are gold.
...
Create a private document, shared with just you and the individual. A simple Google Doc works. Use it to:

- Track discussion topics as they arise throughout the week
- Document what was said and what needs to happen next
- Revisit ideas you want to follow up on later
...
Set up a recurring weekly 1:1 with your manager. Don't wait for them to make the move. Get it on the calendar.
...
This gives you good material to explore in your early 1:1s.
...
It's not flashy, but it works. You're laying the foundation for a healthy, high-trust team.

---

Next up, we'll go deeper into those first 1:1s and introduce a concept called **Contracting**, a way to set mutual expectations with your direct reports from the start.

...
In the last post, we talked about systems and routines, tools to help manage the chaos and create a sense of structure in your day. Once you have that rhythm in place, the next question is: **how should you spend your time to create the most impact?**

To help answer that, I want to zoom in on four categories of work that Andy Grove outlines in his classic book, High Output Management. These categories give you a practical lens for your daily interactions and contributions as a manager.
...
Here's each one, then a walk through a day using these categories as a guide.

---

## 1. Information Gathering

As a manager, your knowledge base is one of your most valuable assets. Everything you do (planning, prioritization, coaching) depends on how well you understand what's going on.
...
Information comes from everywhere, not just formal settings. A passing comment at the coffee machine might give you insight into another team's roadmap. Useful weeks later when planning cross-team work. Stay curious, stay observant, and keep logging what you learn.

---

## 2. Decision Making

This is the one people associate most with management. It's not your only job, but it is an important one.

Decisions come in all sizes, from approving time off to green-lighting multi-million-dollar projects. No matter the scale, treat each with intention. The people around you don't always have the authority to decide, so your choices carry weight.
...
You're not always the decision-maker. That doesn't mean you're passive. Nudging is offering a perspective, planting a seed, helping a team see something they missed.
...
These aren't mandates. They're contributions. Done consistently, they shape outcomes across the business.
...
Don't only model behavior within your team. Look beyond. Build relationships across departments. Show up with curiosity. Help others see how Engineering, Product, and Commercial can align. That's leadership too.

---

## A Day Through the Lens

A pretty typical day, mapped to the four categories:
...
When you start viewing your day through the lens of these four activities, small moments start to feel more intentional.

That Slack conversation? Maybe it was nudging.  
That coffee chat? Information gathering.  
That impromptu praise? Role modeling.  
That decision you made without realizing it? Now you see it.

Management feels abstract. This framework brings clarity. Try tracking your own day using these categories.

...
Tech interviews have become legendary, sometimes in the worst possible way. Horror stories abound: brain teasers, whiteboard marathons, and logic puzzles that would stump a panel on *University Challenge*. A lot has been written from the candidate's perspective. Not enough covers what it's like on the other side of the table.

This is for managers and interviewers, especially those designing or running the process themselves. What makes interviews effective, efficient, and respectful for everyone involved.
...
Some companies run 6 to 10 interviews. That's a lot. At smaller companies or startups, where candidates are often fielding multiple offers, you need to move faster.

I've found that a **2 to 3 stage process** works well for most engineering roles:
...
No matter the outcome, candidates should leave feeling like your company is a good place to work. Treat them like people, not problems to solve.
...
Everyone who submits gets feedback. Even those we pass on should walk away with something constructive, and ideally, the sense that they could try again later.

---

## Second Interview: Technical Deep Dive

This is run by peers, not the hiring manager. It's where the technical rubber meets the road.
...
The goal isn't to trip them up. You're trying to understand:
...
Great for architectural diagrams, system design, or algorithm flow. Terrible for writing syntactically perfect code.
...
Watch how they work, how they ask for help, and how they navigate unfamiliar territory. That's more valuable than whether they remember how to reverse a binary tree.
...
Why? Under some state hiring laws, candidates can request interview notes. If they did, would your feedback help them improve, or leave them confused?

> Important: Be honest with yourself.  
> If you're tempted to say yes to "give them a shot," but know deep down they're not right, don't. It's harder to undo a bad hire than to decline at the offer stage.
...
- Give candidates every opportunity to show who they are.
- Leave them better than you found them.
- Stay fair, stay focused, and make decisions you're proud of.

You won't get it right every time. With care and practice, you'll build a hiring process that respects candidates, supports your team, and brings the right people through the door.
